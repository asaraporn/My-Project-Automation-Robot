...
class LogResultListener:
    ...
    def __init__(self):
        ...
        self.SUBJECT = "Test Automate test"
    ...
    def close(self):
        ...
        # summary_content(self.SEND_EMAIL, self.SUBJECT, self.SMPT, self.FROM, self.PASSWORD, self.TO, self.CC,
...
def summary_content(send_email, subject, smtp, from_user, pwd, to, cc, total, passed, failed, percentage, exe_date,
               elapsed_time, company_name):

    if send_email:
        summary_content = """ 
    ### Summary Test Result [ %s ]####
        Test date : [%s]
            - Total = %s
            - Passed = %s
            - Failed = %s """ \
                             % ( company_name , exe_date ,total , passed,failed )
...
def send_email(send_email, subject, smtp, from_user, pwd, to, cc, total, passed, failed, percentage, exe_date,
    ...
    if send_email:
        ...
        """ % (company_name, total, passed, failed, percentage, exe_date, platform.uname()[1], platform.uname()[0],
               elapsed_time)
